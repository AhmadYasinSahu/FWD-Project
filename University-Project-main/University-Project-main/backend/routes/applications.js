...
const ResearchGrantApplication = require('../models/ResearchGrantApplication.js');
const User = require('../models/User.js');
const { protect, authorize } = require('../middleware/auth.js');
const { uploadDocument, uploadMultiple, handleUploadError } = require('../middleware/upload.js');
const { sendApplicationStatusEmail } = require('../utils/sendEmail.js');
